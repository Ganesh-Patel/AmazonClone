  ...
  async (country = 'US', { rejectWithValue }) => {
    try {
      const response = await axios.get(
        'https://real-time-amazon-data.p.rapidapi.com/product-category-list',
        {
          params: { country },
          headers: {
...
const categorySlice = createSlice({
  ...
  initialState: {
    data: [ { "name": "All Departments", "id": "aps" },
        ...
        { "name": "Women", "id": "fashion-womens" },
        { "name": "Men", "id": "fashion-mens" },
        { "name": "Girls", "id": "fashion-girls" },
        { "name": "Boys", "id": "fashion-boys" },
        { "name": "Baby", "id": "fashion-baby" },
